  ...
  return (
    <section className="relative pt-16 bg-background text-foreground">
      <div className="max-w-5xl mx-auto text-center px-4">
        ...
        >
          We’re a passionate global crew building the next generation of
          project management. Come join our mission to make work easier.
        </motion.p>
      </div>
            ...
            {({ geographies }) =>
              geographies.map((geo) => (
                <Geography
                  key={geo.rsmKey}
                  geography={geo}
                  /* ✅ CSS variable + transition for smooth theme change */
                  style={{
                    default: {
